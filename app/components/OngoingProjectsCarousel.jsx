      ...
      <div className="mx-auto w-full max-w-350 px-4 md:px-8 lg:px-10">
        ...
        <div className="relative overflow-hidden rounded-3xl">
          ...
          <div className="absolute inset-x-0 bottom-0 p-6 text-white md:p-10">
            ...
            <h3 className="mt-3 max-w-3xl font-serif text-3xl font-bold leading-tight md:text-5xl">
              {current.title}
            </h3>
            <a
              href="#"
              className="mt-6 inline-flex h-12 items-center justify-center rounded-full bg-[#63c37a] px-8 text-base font-bold text-white transition-colors hover:bg-[#459557]"
            >
              SUPPORT NOW
            </a>
          </div>
