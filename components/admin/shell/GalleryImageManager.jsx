...
// Gallery photos use direct-manipulation autosave: each add/remove persists
// immediately (with an undo toast) — content managers expect photo tools to
// "just save". The hero & section headings are edited on the parent
// /admin/pages/gallery page.
export function GalleryImageManager() {
  ...
  usePageChrome({
    ...
    breadcrumbHref: "/admin/pages/gallery",
    title: "Photos",
